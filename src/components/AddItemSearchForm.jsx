...
export default function AddItemSearchForm({ search }) {
    ...
    return (
        <form className="flex items-center mb-3" onSubmit={handleSubmit} >
            ...
            <button type="submit" className="p-2.5 ms-2 text-sm font-medium text-white bg-[#2D3142] rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
